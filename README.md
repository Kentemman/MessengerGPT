...
2. Check the console of your Flask server to see the input message and the response from OpenAI GPT-3.
4. Check the Facebook Messenger conversation to see the chatbot's response.
